...
from service.service import dropCollection, intializeDb

testItem = {"_id": 99999, "name": "+5 Dexterity Vest", "sell_in": 10, "quality": 20}
sulfuras = {"_id": 888, "name": "Aged Brie", "sell_in": 0, "quality": 10}
...
@pytest.mark.test_service
def test_get_item():
    testItem = {"name": "+5 Dexterity Vest", "sell_in": 10, "quality": 20}
...
def test_update_item():
    ...
    resultItem = {"name": "+5 Dexterity Vest", "sell_in": 9, "quality": 18}
...
def test_update_AgedBrie_item():
    ...
    resultAgedBrie = {"name": "Aged Brie", "sell_in": -1, "quality": 11}
